...
const sections: readonly NavSection[] = [
  {
    ...
    title: "Admin",
    items: [
      { id: "home",    label: "Bosh Sahifa",        icon: IoHomeOutline,        path: "/admin-dash" },
      { id: "soulte",  label: "Foydalanuvchilar",    icon: FaUser,    path: "/soulte" },
      { id: "grammar", label: "Azolar",     icon: SlUserFollowing,    path: "/grammar" },
      { id: "dict",    label: "Darslik Qo'shish",            icon: IoCreate,    path: "/lugat" },
      { id: "tests",   label: "Darsliklar",            icon: IoDocumentText,    path: "/tests" },
     { id: "faq",     label: "Ko‘p so‘raladigan savollar", icon: FaQuestionCircle, path: "/faq", muted: true },
    ],
  },
] as const;

export default function AdminSidebar({ navH = "56px" }: SidebarProps) {
